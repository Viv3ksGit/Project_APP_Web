...
const SLOKAS: Sloka[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      {
        tamil: "யுக ஸஹஸ்ர யோஜன பர பானு, லீல்யோ தாஹி மதுர பல ஜானு",
        english: "Yug Sahasra Yojan Par Bhanu, Leelyo Tahi Madhur Phal Janu",
        pronunciation: "Yug Sa-has-ra Yo-jan Par Bha-nu, Leel-yo Ta-hi Ma-dhur Phal Ja-nu",
        meaning: "You leapt thousands of miles to the Sun, taking it to be a sweet fruit.",
      },
      {
        tamil: "ப்ரபு முத்ரிகா மேலி முக மாஹீ, ஜலதி லாங்கி கயே அச்ரஜ நாஹீ",
        english: "Prabhu Mudrika Meli Mukh Mahi, Jaladhi Langhi Gaye Achraj Nahi",
        pronunciation: "Pra-bhu Mud-ri-ka Me-li Mukh Ma-hi, Ja-la-dhi Lang-hi Ga-ye Ach-raj Na-hi",
        meaning: "With the Lord's ring in your mouth, you leapt across the ocean — no wonder at all.",
      },
      {
        tamil: "துர்கம காஜ ஜகத கே ஜேதே, ஸுகம அனுக்ரஹ தும்ஹரே தேதே",
        english: "Durgam Kaj Jagat Ke Jete, Sugam Anugraha Tumhre Tete",
        pronunciation: "Dur-gam Kaj Ja-gat Ke Je-te, Su-gam A-nug-ra-ha Tum-hre Te-te",
        meaning: "All the hardest tasks in the world become easy through your grace.",
      },
      {
        tamil: "ராம துவாரே தும ரகவாரே, ஹோத ந ஆஜ்ஞா பினு பைஸாரே",
        english: "Ram Duware Tum Rakhware, Hot Na Agya Binu Paisare",
        pronunciation: "Ram Du-wa-re Tum Rakh-wa-re, Hot Na Ag-ya Bi-nu Pai-sa-re",
        meaning: "You guard the gateway of Rama; none may enter without your leave.",
      },
      {
        tamil: "ஸப ஸுக லஹை தும்ஹாரி ஸரனா, தும ரக்ஷக காஹு கோ டர னா",
        english: "Sab Sukh Lahai Tumhari Sarna, Tum Rakshak Kahu Ko Dar Na",
        pronunciation: "Sab Sukh La-hai Tum-ha-ri Sar-na, Tum Rak-shak Ka-hu Ko Dar Na",
        meaning: "All comfort is found in your refuge; with you as protector, there is no fear.",
      },
      {
        tamil: "ஆபன தேஜ ஸம்ஹாரோ ஆபை, தீனோன லோக ஹாங்க தே காம்பை",
        ...
        meaning: "You alone contain your own might; all three worlds tremble at your roar.",
      },
      {
        tamil: "பூத பிஶாச நிகட நஹீ ஆவை, மஹாவீர ஜப நாம ஸுனாவை",
        english: "Bhoot Pisach Nikat Nahi Aavai, Mahavir Jab Naam Sunavai",
        pronunciation: "Bhoot Pi-sach Ni-kat Na-hi Aa-vai, Ma-ha-vir Jab Naam Su-na-vai",
        meaning: "Ghosts and evil spirits dare not approach when the mighty one's name is chanted.",
      },
      {
        tamil: "நாஸை ரோக ஹரை ஸப பீரா, ஜபத நிரந்தர ஹனுமத பீரா",
        english: "Nase Rog Hare Sab Peera, Japat Nirantar Hanumat Beera",
        pronunciation: "Na-se Rog Ha-re Sab Pee-ra, Ja-pat Ni-ran-tar Ha-nu-mat Bee-ra",
        meaning: "Diseases vanish and all pain is removed by ceaseless remembrance of brave Hanuman.",
      },
      {
        tamil: "ஸங்கட தே ஹனுமான சுடாவை, மன க்ரம பசன த்யான ஜோ லாவை",
        english: "Sankat Te Hanuman Chhudavai, Man Kram Bachan Dhyan Jo Lavai",
        pronunciation: "San-kat Te Ha-nu-man Chhu-da-vai, Man Kram Ba-chan Dhyan Jo La-vai",
        meaning: "Hanuman frees from all troubles those who remember him in thought, deed, and word.",
      },
      {
        tamil: "ஸப பர ராம தபஸ்வீ ராஜா, தின கே காஜ ஸகல தும ஸாஜா",
        ...
        meaning: "Rama is the supreme ascetic king; you accomplish all of his tasks.",
      },
      {
        tamil: "ஔர மனோரத ஜோ கோயி லாவை, ஸோயி அமித ஜீவன பல பாவை",
        english: "Aur Manorath Jo Koi Lavai, Soi Amit Jeevan Phal Pavai",
        pronunciation: "Aur Ma-no-rath Jo Koi La-vai, Soi A-mit Jee-van Phal Pa-vai",
        meaning: "Whoever brings any heartfelt wish to you attains its boundless fruit in life.",
      },
      {
        tamil: "சாரோன ஜுக பரதாப தும்ஹாரா, ஹை பரஸித்த ஜகத உஜியாரா",
        english: "Charon Jug Partap Tumhara, Hai Parsiddh Jagat Ujiyara",
        pronunciation: "Cha-ron Jug Par-tap Tum-ha-ra, Hai Par-siddh Ja-gat U-ji-ya-ra",
        meaning: "Your glory shines through all four ages, renowned and illuminating the world.",
      },
      {
        tamil: "ஸாது ஸந்த கே தும ரகவாரே, அஸுர நிகந்தன ராம துலாரே",
        english: "Sadhu Sant Ke Tum Rakhware, Asur Nikandan Ram Dulare",
        pronunciation: "Sa-dhu Sant Ke Tum Rakh-wa-re, A-sur Ni-kan-dan Ram Du-la-re",
        meaning: "You protect saints and sages, destroy demons, and are beloved of Rama.",
      },
      {
        tamil: "அஷ்ட ஸித்தி நௌ நிதி கே தாதா, அஸ பர தீன்ஹ ஜானகீ மாதா",
        english: "Ashta Siddhi Nau Nidhi Ke Data, As Bar Deenh Janaki Mata",
        pronunciation: "Ash-ta Sid-dhi Nau Ni-dhi Ke Da-ta, As Bar Deenh Ja-na-ki Ma-ta",
        meaning: "Mother Sita blessed you to bestow the eight powers and nine treasures.",
      },
      {
        tamil: "ராம ரஸாயன தும்ஹாரே பாஸா, ஸதா ரஹோ ரகுபதி கே தாஸா",
        ...
        meaning: "You hold the elixir of devotion to Rama, ever remaining his servant.",
      },
      {
        tamil: "தும்ஹரே பஜன ராம கோ பாவை, ஜனம ஜனம கே துக பிஸராவை",
        ...
        meaning: "Through your worship one attains Rama and is freed from the sorrows of countless births.",
      },
      {
        tamil: "அந்த கால ரகுபர புர ஜாயீ, ஜஹான ஜனம ஹரி-பக்த கஹாயீ",
        english: "Ant Kaal Raghubar Pur Jai, Jahan Janam Hari-Bhakt Kahai",
        pronunciation: "Ant Kaal Ra-ghu-bar Pur Jai, Ja-han Ja-nam Ha-ri-Bhakt Ka-hai",
        meaning: "At life's end one reaches Rama's abode, reborn as a devotee of Hari.",
      },
      {
        tamil: "ஔர தேவதா சித்த ந தராயீ, ஹனுமத ஸேயி ஸர்வ ஸுக கராயீ",
        english: "Aur Devta Chitt Na Dharai, Hanumat Sei Sarva Sukh Karai",
        pronunciation: "Aur Dev-ta Chitt Na Dha-rai, Ha-nu-mat Sei Sar-va Sukh Ka-rai",
        meaning: "One need hold no other deity in mind; serving Hanuman brings all happiness.",
      },
      {
        tamil: "ஸங்கட கடை மிடை ஸப பீரா, ஜோ ஸுமிரை ஹனுமத பல்பீரா",
        english: "Sankat Katai Mite Sab Peera, Jo Sumirai Hanumat Balbeera",
        pronunciation: "San-kat Ka-tai Mi-te Sab Pee-ra, Jo Su-mi-rai Ha-nu-mat Bal-bee-ra",
        meaning: "All troubles end and every pain vanishes for those who remember mighty Hanuman.",
      },
      {
        tamil: "ஜெய் ஜெய் ஜெய் ஹனுமான கோஸாயீ, க்ருபா கரஹு குருதேவ கீ நாயீ",
        english: "Jai Jai Jai Hanuman Gosai, Kripa Karahu Gurudev Ki Nai",
        pronunciation: "Jai Jai Jai Ha-nu-man Go-sai, Kri-pa Ka-ra-hu Gu-ru-dev Ki Nai",
        meaning: "Victory, victory, victory to Lord Hanuman! Bestow grace upon me as my Guru.",
      },
      {
        tamil: "ஜோ ஶத பார பாட கர கோயி, சூடஹி பந்தி மஹா ஸுக ஹோயி",
        english: "Jo Shat Bar Path Kar Koi, Chhutahi Bandi Maha Sukh Hoi",
        pronunciation: "Jo Shat Bar Path Kar Koi, Chhu-ta-hi Ban-di Ma-ha Sukh Hoi",
        meaning: "Whoever recites this a hundred times is freed from bondage and attains great bliss.",
      },
      {
        tamil: "ஜோ யஹ படை ஹனுமான சாலீஸா, ஹோய ஸித்தி ஸாகீ கௌரீஸா",
        english: "Jo Yah Padhe Hanuman Chalisa, Hoy Siddhi Sakhi Gaurisa",
        pronunciation: "Jo Yah Pad-he Ha-nu-man Cha-li-sa, Hoy Sid-dhi Sa-khi Gau-ri-sa",
        meaning: "Whoever reads this Hanuman Chalisa attains perfection, with Lord Shiva as witness.",
      },
      {
        tamil: "துலஸீதாஸ ஸதா ஹரி சேரா, கீஜை நாத ஹ்ருதய மஹ டேரா",
        english: "Tulsidas Sada Hari Chera, Keejai Nath Hriday Mah Dera",
        pronunciation: "Tul-si-das Sa-da Ha-ri Che-ra, Kee-jai Nath Hri-day Mah De-ra",
        meaning: "Tulsidas is ever Hari's servant; O Lord, make your dwelling within my heart.",
      },
      {
        tamil: "பவன தனய ஸங்கட ஹரண, மங்கல மூரதி ரூப; ராம லகன ஸீதா ஸஹித, ஹ்ருதய பஸஹு ஸுர பூப",
        ...
        meaning:
          "O son of the Wind, remover of afflictions, embodiment of auspiciousness — dwell in my heart with Rama, Lakshman, and Sita, O king of the gods.",
      },
    ],
  },
  {
